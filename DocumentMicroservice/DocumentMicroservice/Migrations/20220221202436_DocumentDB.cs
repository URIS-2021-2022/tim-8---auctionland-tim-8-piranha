    ...
    public partial class DocumentDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Document",
                columns: new[] { "documentId", "docStatusID", "documentCreationDate", "documentDate", "documentStatusdocStatusID", "documentTemplate", "registrationNumber" },
                values: new object[,]
                {
                    { new Guid("07af89f2-feee-4680-b489-9d0e31699588"), new Guid("93a08cc2-1d17-46e6-bd95-4fa70bb11226"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Kreiranje predloga plana", "119833332" },
                    { new Guid("3a3e6366-3a20-4d3b-ae15-be85ba277683"), new Guid("458adb42-62a5-4117-8101-7d933fa88abb"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Obrazovanje komisije za davanje misljenja", "122267432" },
                    { new Guid("0ec20a3b-fd39-4c2e-8062-7d1664eb5381"), new Guid("84ff030b-7067-45b7-8bb2-10719534f91e"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Saglasnost ministra", "119834232" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("86c9ac76-a632-4ffc-b2a2-26ea8600dc86"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("0ec20a3b-fd39-4c2e-8062-7d1664eb5381"), new Guid("e54364be-1fe6-43b5-9401-8b8bd2165aba"), "Zrenjanin", "2342323", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
